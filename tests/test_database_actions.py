...
class TestDatabaseActions(unittest.TestCase):
    ...
    def test_synchronization(self):
        ...
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder'),
                                      (get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder'),
                                      (get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder'),
                                      (get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder'),
                                      (get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder'),
        ...
        self.assertIsNone(synchronize((get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'three_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder'),
        ...
        self.assertIsNone(synchronize((get_agent_id('two_test_user', 'two_test_mac'), 'four_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder'),
        ...
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'five_test_folder'),
                                      (get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'one_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder'),
                                      (get_agent_id('one_test_user', 'one_test_mac'), 'two_test_folder')))
        self.assertIsNone(synchronize((get_agent_id('three_test_user', 'three_test_mac'), 'six_test_folder'),
